...
classdef Automatic_Labeling < vision.labeler.AutomationAlgorithm
    ...
    methods
        ...
        function isValid = checkLabelDefinition(algObj, labelDef)
            ...
            % Definition of Digit Classes (D0 ~ D9)
            if (strcmpi(labelDef.Name, 'D0') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D1') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D2') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D3') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D4') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D5') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D6') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D7') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D8') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'D9') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;

            elseif (strcmpi(labelDef.Name, 'None') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.LabelName = labelDef.Name;
    ...
    methods
        ...
        function autoLabels = run(algObj, I)
            ...
            [labelCord, label] = Func_DigitDetector(I, algObj, 1);   %% Point_1             
            autoLabels(1).Name = char(label);
            autoLabels(1).Type = labelType('Rectangle');
            autoLabels(1).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 2);   %% Point_2             
            autoLabels(2).Name = char(label);
            autoLabels(2).Type = labelType('Rectangle');
            autoLabels(2).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 3);   %% Point_3             
            autoLabels(3).Name = char(label);
            autoLabels(3).Type = labelType('Rectangle');
            autoLabels(3).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 4);   %% Point_4             
            autoLabels(4).Name = char(label);
            autoLabels(4).Type = labelType('Rectangle');
            autoLabels(4).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 5);   %% Point_5             
            autoLabels(5).Name = char(label);
            autoLabels(5).Type = labelType('Rectangle');
            autoLabels(5).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 6);   %% Point_6             
            autoLabels(6).Name = char(label);
            autoLabels(6).Type = labelType('Rectangle');
            autoLabels(6).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 7);   %% Point_7             
            autoLabels(7).Name = char(label);
            autoLabels(7).Type = labelType('Rectangle');
            autoLabels(7).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 8);   %% Point_8             
            autoLabels(8).Name = char(label);
            autoLabels(8).Type = labelType('Rectangle');
            autoLabels(8).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 9);   %% Point_9             
            autoLabels(9).Name = char(label);
            autoLabels(9).Type = labelType('Rectangle');
            autoLabels(9).Position = labelCord;   

            [labelCord, label] = Func_DigitDetector(I, algObj, 10);   %% Point_10             
            autoLabels(10).Name = char(label);
            autoLabels(10).Type = labelType('Rectangle');
            autoLabels(10).Position = labelCord;   
